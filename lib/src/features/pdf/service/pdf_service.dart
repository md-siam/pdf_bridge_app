...
class PdfService {
  PdfService({required FilePathService filePathService}) : _filePathService = filePathService;
  ...
  Future<CreatePdfResponse> generatePdf(PdfFormData formData) async {
    ...
    final request = CreatePdfRequest(outputPath: outputPath, title: formData.title, body: formData.body, author: formData.author, imageBytes: formData.imageBytes);
